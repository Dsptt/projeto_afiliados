...
// URLs to scrape
const SCRAPE_URLS = [
    { url: 'https://www.amazon.com.br/deals', category: 'deals', type: 'deals' as const },
    { url: 'https://www.amazon.com.br/gp/bestsellers/electronics', category: 'electronics', type: 'bestsellers' as const },
    { url: 'https://www.amazon.com.br/gp/bestsellers/kitchen', category: 'home', type: 'bestsellers' as const },
    { url: 'https://www.amazon.com.br/gp/bestsellers/sports', category: 'sports', type: 'bestsellers' as const },
    { url: 'https://www.amazon.com.br/gp/bestsellers/toys', category: 'toys', type: 'bestsellers' as const },
];
...
function calculateDealScore(product: Partial<ScrapedProduct>): number {
...
function filterQualityProducts(products: ScrapedProduct[]): ScrapedProduct[] {
...
async function scrapeAmazon(browser: Browser): Promise<ScrapedProduct[]> {
...
async function uploadToFirebase(products: ScrapedProduct[]): Promise<{ newCount: number; updateCount: number }> {
    // Initialize Firebase
...
export { main, scrapeAmazon, uploadToFirebase };
